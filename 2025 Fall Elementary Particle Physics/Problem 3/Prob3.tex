...
\begin{align}
    ...
    &=\frac{2(u\overline{u}+d\overline{d}+s\overline{s})}{\sqrt{6}}-\frac{3d\overline{d}+3s\overline{s}}{\sqrt{6}}.
\end{align}
In order to see they are indeed U-triplet and U-singlet, we can analyze their quark content with U-spin quantum numbers:
\begin{itemize}
    \item u quark: $U=0$ (U-spin singlet)
    \item d quark: $U=\tfrac{1}{2}$, $U_3=+\tfrac{1}{2}$
    \item s quark: $U=\tfrac{1}{2}$, $U_3=-\tfrac{1}{2}$
    \item $\overline{u}$ quark: $U=0$ (U-spin singlet)
    \item $\overline{d}$ quark: $U=\tfrac{1}{2}$, $U_3=-\tfrac{1}{2}$
    \item $-\overline{s}$ quark: $U=\tfrac{1}{2}$, $U_3=+\tfrac{1}{2}$
\end{itemize}
For $\overline{s}$ quark, we need to add a minus sign due to the same reason in the isospin $SU(2)$ case. Hence, we can see that $\pi^0_U$ is a U-triplet component with $U=1, U_3=0$, and $\eta^0_U$ is a U-singlet with $U=0$. 
...
\textbf{Remark:} I think the U-singlet should be $\eta_U^0=\frac{d\overline{d}+s\overline{s}}{\sqrt{2}}$, which is different from the one given in the question. It is a more natural choice since it is orthogonal to the U-triplet component $\pi_U^0=\frac{d\overline{d}-s\overline{s}}{\sqrt{2}}$. If we use this definition, we can see that $\eta_U^0$ does not contain any $u\overline{u}$ component. However, using this definition, we cannot express $\eta_U^0$ in terms of $\pi^0$ and $\eta$ as given in the question.\\
