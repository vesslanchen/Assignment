...
\begin{enumerate}
    ...
    \item \textbf{Remark:} I also check the C-G coefficients, and find that the state $|I=2, I_3=2\rangle$ is given by
    \begin{align}
    ...
    \end{align}
    The $|1,0\rangle $ state contains the $|\Lambda\pi^0\rangle$ component. This means that the $\Lambda$ and $\pi^0$ can form isospin $I=1$ state. This is consistent with our analysis above.
\end{enumerate}\qed