...
\begin{align}
    P = P_1 P_2 (-1)^l,
\end{align}
where $P_1$ and $P_2$ are the intrinsic parities of the two particles, and $l$ is their relative orbital angular momentum. Since the $\theta$ has spin $0$, the two pions must have total angular momentum $0$. The two pions are identical bosons, so they must be in a symmetric state. This means that $l$ must be even. The lowest even value is $l=0$. Thus, we have
\begin{itemize}
    \item [(b)]
\end{itemize}
\begin{itemize}
