...
\textbf{2026 Fall Mathematics 8302\\Differential Topology}\\ 
Assignment Solution}
\author{Lecture Instructor: Professor Erkao Bao \\ \\
...
\begin{titlepage}
    ...
    \vspace{2cm}
    {\large Lecture Instructor: Professor Erkao Bao \par}
    \vspace{1cm}
