...
\begin{align}
    &M_1 = M_2 = 0, \\
    &M_3 = 0, \\
    &M_4 = M_5 =  \frac{\sqrt{3}}{2}gv , \\
    &M_6 = M_7 =  \frac{\sqrt{3}}{2}gv , \\
    &M_8 = 0.
\end{align}
Thus, in this case, we have 4 massive gauge bosons with mass $ \frac{\sqrt{3}}{2}gv $ and 4 massless gauge bosons. If we choose $v_3 = v$ and $v_8 = 0$, then the masses of the gauge bosons can be simplified to
\begin{align}
    &M_1 = M_2 = g v, \\
    &M_3 = 0, \\
    &M_4 = M_5 = \frac{gv}{2}, \\
    &M_6 = M_7 = \frac{gv}{2}, \\
    &M_8 = 0.
\end{align} Thus, in this case, we have 2 massive gauge bosons with mass $g v$, 4 massive gauge bosons with mass $\frac{gv}{2}$, and 2 massless gauge bosons. Hence, we summarize the results as follows:
\begin{itemize}
    \item[(a)] In the case $v_3 = 0$ and $v_8 = v$, the remaining unbroken gauge symmetry is SU(2) $\times$ U(1), where the SU(2) subgroup is generated by $T^1$, $T^2$, and $T^3$, and the U(1) subgroup is generated by $T^8$. The gauge bosons corresponding to the SU(2) subgroup and the U(1) subgroup remain massless. The massless bosons are $A_\mu^1$, $A_\mu^2$, $A_\mu^3$, and $A_\mu^8$. The massive bosons are $A_\mu^4$, $A_\mu^5$, $A_\mu^6$, and $A_\mu^7$ with mass $ \frac{\sqrt{3}}{2}gv $.
    \item [(b)]In the case $v_3 = v$ and $v_8 = 0$, the remaining unbroken gauge symmetry is U(1) $\times$ U(1), where one U(1) subgroup is generated by $T^3$ and the other U(1) subgroup is generated by $T^8$. The gauge bosons corresponding to both U(1) subgroups remain massless. The massless bosons are $A_\mu^3$ and $A_\mu^8$. The massive bosons are $A_\mu^1$ and $A_\mu^2$ with mass $g v$, and $A_\mu^4$, $A_\mu^5$, $A_\mu^6$, and $A_\mu^7$ with mass $\frac{gv}{2}$.
    \item [(c)] In the general case where both $v_3$ and $v_8$ are nonzero, if $v_3\neq \pm \sqrt{3} v_8$, then the remaining unbroken gauge symmetry is U(1)$\times$U(1).The gauge bosons corresponding to both U(1) subgroups remain massless. The massless bosons are $A_\mu^3$ and $A_\mu^8$. The rest of the gauge bosons are massive with masses given by the above expressions. If $v_3 = \pm \sqrt{3} v_8$, then the remaining unbroken gauge symmetry is SU(2) $\times$ U(1). The gauge bosons corresponding to the SU(2) subgroup and the U(1) subgroup remain massless.
\end{itemize}
\qed