...
\begin{align}
    ...
    =&({\delta^\mu}_\tau +{\delta\omega^\mu}_\tau -{\delta\omega^\mu}_\tau )\Big[\partial^\tau \varphi(x)-{\delta\omega^\alpha}_\nu(\delta^\nu_\beta x^\beta \partial_\alpha\partial^\tau \varphi(x)+g^{\nu\tau}\partial_\alpha \varphi(x))\Big]
\end{align}
